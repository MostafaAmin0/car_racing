  ...
  void selectGuide(){
    if(mouseX>=width/2-125 && mouseX<=width/2+125 && mouseY>=height-150 && mouseY<=height-90){
      if(mousePressed){
        ...
        img2=loadImage("Car 1.png");

        image(img2,width/2-260,height-350,img2.width*0.2,img2.height*0.2);
        text("Player 1",width/2-200,height-330);
        text("Control keys: (4 Arrows)",width/2-200,height-300);
        
        image(img1,width/2-260,height-200,img1.width*0.2,img1.height*0.2);
